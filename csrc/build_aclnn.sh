...
if [[ "$SOC_VERSION" =~ ^ascend310 ]]; then
    ...
    CUSTOM_OPS_ARRAY=(
        ...
        "tq_dequant_mse_paged_scaled"
        "tq_dequant_prod_paged"
        "tq_prod_paged_k_score"
        "tq_prod_mse_paged_attention"
        "tq_encode_mse_paged_cache"
        "tq_encode_prod_paged_cache"
