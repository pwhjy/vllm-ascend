...
cmd=(
  ...
  --output-dir "${OUT}"
  --env VLLM_ASCEND_TQ_USE_FUSED_KV_UPDATE_ATTENTION=1
  --env VLLM_ASCEND_TQ_USE_CUSTOM_FUSED_KV_UPDATE_ATTENTION=0
  --env VLLM_ASCEND_TQ_USE_CUSTOM_ENCODE_CACHE_UPDATE=1
  --env VLLM_ASCEND_TQ_USE_FUSED_DECODE_DENSE_FIA=1
  --env VLLM_ASCEND_TQ_USE_FUSED_DECODE_ATTENTION_M4=1
  --env VLLM_ASCEND_TQ_M4_GROUPED_Q=0
  --env VLLM_ASCEND_TQ_M4_SCORE_TILE_LEN=0
  --env VLLM_ASCEND_TQ_PROFILE_M4_STAGES="${PROFILE_M4_STAGES}"
  --env VLLM_ASCEND_TQ_PROFILE_M4_SHADOW=0
  --env VLLM_ASCEND_TQ_USE_COMPRESSED_DECODE_CURRENT=0
  --env VLLM_ASCEND_TQ_USE_COMPRESSED_DECODE_CUSTOM_K_SCORE=0
  --env VLLM_ASCEND_TQ_USE_DECODE_COMPRESSED_FULL_CACHE=0
)
