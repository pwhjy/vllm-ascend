...
Optional:
  ...
  M4_GROUPED_Q=0
  M4_HISTORY_PARTITIONS=1
  M4_SCORE_TILE_LEN=64
  M4_PRETRANSFORM_QUERY=1
  M4_FORCE_FP32_INPUT=1
  M4_STRUCTURED_FAST=1
  M4_DEBUG_MODE=0
  ENCODE_V_PARTITIONS=1
  ENCODE_FORCE_FP32_INPUT=1
  ENCODE_STRUCTURED_FAST=1
  ENCODE_DEBUG_COMPARE=0
...
M4_GROUPED_Q="${M4_GROUPED_Q:-0}"
M4_HISTORY_PARTITIONS="${M4_HISTORY_PARTITIONS:-1}"
M4_SCORE_TILE_LEN="${M4_SCORE_TILE_LEN:-64}"
...
ENCODE_FORCE_FP32_INPUT="${ENCODE_FORCE_FP32_INPUT:-1}"
ENCODE_STRUCTURED_FAST="${ENCODE_STRUCTURED_FAST:-1}"
ENCODE_DEBUG_COMPARE="${ENCODE_DEBUG_COMPARE:-0}"
...
if [[ "${PRESERVE_TQ_ENV}" != "1" ]]; then
  ...
  unset VLLM_ASCEND_TQ_DEBUG_COMPARE_ENCODE
  unset VLLM_ASCEND_TQ_M4_GROUPED_Q
  unset VLLM_ASCEND_TQ_M4_HISTORY_PARTITIONS
  ...
  unset VLLM_ASCEND_TQ_M4_STRUCTURED_FAST
...
cmd=(
  ...
  --env-fused VLLM_ASCEND_TQ_DEBUG_COMPARE_ENCODE="${ENCODE_DEBUG_COMPARE}"
  --env-fused VLLM_ASCEND_TQ_M4_GROUPED_Q="${M4_GROUPED_Q}"
  --env-fused VLLM_ASCEND_TQ_M4_HISTORY_PARTITIONS="${M4_HISTORY_PARTITIONS}"
  --env-fused VLLM_ASCEND_TQ_M4_SCORE_TILE_LEN="${M4_SCORE_TILE_LEN}"
  ...
  --env-fused VLLM_ASCEND_TQ_M4_STRUCTURED_FAST="${M4_STRUCTURED_FAST}"
